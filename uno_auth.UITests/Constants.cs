namespace uno_auth.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5001/";
    public readonly static string iOSAppName = "com.companyname.unoauth";
    public readonly static string AndroidAppName = "com.companyname.unoauth";
